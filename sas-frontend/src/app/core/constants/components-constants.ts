...
export class Constants {
    ...
    public static users: IConstants = {
        ...
        fields: [
            ...
            {id: 5, name: 'Nivel de permissão', apiField: 'roles',    isTableField: true,  tableType: "", isFilterField: true,  filterType: "select", isObject: true, objectId: 'id', objectName: 'name'},
